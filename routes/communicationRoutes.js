...
router.get(
    '/',
    isAuthenticated,
    communicationController.getChatInterface
);

// 1.bis. CONTACTOS + USUARIOS EN JSON (para filtrado/buscador futuro)
// GET /dashboard/communication/contacts
router.get(
    '/contacts',
    isAuthenticated,
    communicationController.getContactsJson
);
