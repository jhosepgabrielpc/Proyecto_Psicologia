...
// Eventos para FullCalendar (vista de calendario)
// GET /dashboard/appointments/events
router.get('/events', appointmentController.getCalendarEvents);

// Crear cita desde el modal "Nueva Cita"
//   - Si el rol es Paciente, el controller fuerza su propio id_paciente.
//   - Si hay solapamiento, devuelve msg=error_overlap para que el front
//     muestre el popup sin borrar los datos del formulario.
 ...
 *    Se mantienen SOLO las que no generan conflicto directo
 *    con las nuevas rutas, y se registran de forma condicional
